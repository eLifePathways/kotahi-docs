...
const MOVED_PAGES = {
  ...
  '/configuration/decision-forms/': '/how-to/build-your-forms/',
  '/configuration/email-templates/': '/how-to/customise-email-templates/',
  '/configuration/managing-users/': '/how-to/manage-users-and-roles/',
  '/configuration/reviewer-forms/': '/how-to/build-your-forms/',
  '/configuration/settings-reference/': '/reference/settings-general/',
  '/configuration/submission-forms/': '/how-to/build-your-forms/',
    '/how-to/build-a-decision-form/': '/how-to/build-your-forms/',
  '/how-to/build-a-reviewer-form/': '/how-to/build-your-forms/',
  '/how-to/build-a-submission-form/': '/how-to/build-your-forms/',
  ...
  '/concepts/use-cases/': '/start-here/who-uses-kotahi/',
  '/introduction/use-cases/': '/start-here/who-uses-kotahi/',
