---
title: "Use cases"
description: "The kinds of publishing and review workflows Kotahi is designed to support."
sidebar:
  order: 4
...
However, Kotahi is not limited to mimicking journals. It can be used as a **preprint server**, for **publish-review-curate (PRC)**, provide **overlay features**, and **innovative scholar-led models**.

Additionally, Kotahi facilitates new output types like **micropublications** and **interactive data papers**.
