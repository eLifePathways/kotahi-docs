---
title: "Why Kotahi?"
description: "Why Kotahi was built, the problems it addresses, and how it fits the scholarly publishing landscape."
sidebar:
  order: 1
...
For years, academic publishing has been dominated by legacy systems developed in the last century. These outdated platforms rely on an [industrial approach](https://www.robotscooking.com/adaptive-systems/) to workflow, which is no longer suitable for the evolving needs of the scholarly community. The world has changed significantly, with a growing emphasis on adaptive, collaborative processes. In response, we developed Kotahi, a modern platform designed to support a wide range of workflows—from traditional journals to [publish-review-curate (PRC)](https://commonplace.knowledgefutures.org/pub/j0a8lxly/release/1) and [emergent scholar-led models](https://www.robotscooking.com/unboxing-scholarly-communications/).
