...
description: "How Kotahi's main interfaces fit together and which roles see what."
sidebar:
  order: 1
...
![Diagram of Kotahi's interconnected pages: Dashboard sits at the centre, linked to Submission Page, Settings, Review Page, Manuscripts Page, Control Page and CMS, with Production Page branching off Manuscripts Page.](../../../assets/screenshots/59fbb3714b25-750w.png)
...
8. **CMS** - controls for customising public-facing pages along with published content endpoints.

To get started with Kotahi, focus on learning the Dashboard, Manuscripts Page, and Control Page.

![The same map of Kotahi pages, with Dashboard, Manuscripts Page and Control Page filled green to mark the three screens to learn first; Submission Page, Settings, Review Page, CMS and Production Page remain unshaded.](../../../assets/screenshots/951f32a32a96-2500w.png)
